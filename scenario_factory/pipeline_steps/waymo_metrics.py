...
from scenario_factory.pipeline import pipeline_map_with_args, PipelineStepExecutionMode, PipelineContext, \
    PipelineStepArguments
from scenario_factory.scenario_types import ScenarioContainer, ScenarioWithWaymoMetrics, ScenarioWithReferenceScenario
...
def pipeline_compute_waymo_metrics(
    args: ComputeWaymoMetricsArguments,
    ctx: PipelineContext,
    ...
    """
    waymo_metrics = compute_waymo_metrics(scenario_container.scenario, scenario_container.scenario)
